 ...
 * @author rafael
 */
public class VendedorClientSE {

    private static final String BASE_URI = "http://localhost:8080/Lab3-MueblesDeLosAlpes-war/webresources/vendedor";
    ...
    public void agregarVendedor(Vendedor vendedor) throws Exception {
        ...
        m.marshal(vendedor, connection.getOutputStream());
    ...
    public List<Vendedor> getVendedores() throws Exception {
        ...
        List<Vendedor> vendedores = new Gson().fromJson(json, new TypeToken<List<Vendedor>>() {
        }.getType());
